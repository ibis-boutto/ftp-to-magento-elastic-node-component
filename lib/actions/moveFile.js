...
async function moveFile(th, sourcePath, targetPath) {
    try {
        ...
        await client.send("CWD /" + paths.dirname(sourcePath))

        th.logger.info("Sending copy: RNFR /" + paths.basename(ourcePath))
        ...
        throw new Error("Could not move file. " + console.error);
    }
